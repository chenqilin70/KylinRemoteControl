...
import com.huwl.oracle.kylinremotecontrol.activity.ValidateActivity;
...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback {
    ...
    public void handleDecode(Result rawResult, Bundle bundle) {
        ...
        final NetMessage netMessag= MessageHandle.GSON.fromJson(result,NetMessage.class);
        User user= MainActivity.getTerminal().getUser();
        netMessag.transformNetMessage();
        netMessag.setUser(user);
        Intent intent=new Intent(this, ValidateActivity.class);
        intent.putExtra("netMessage",netMessag);
